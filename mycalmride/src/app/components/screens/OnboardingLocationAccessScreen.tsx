...
import svgPaths from '../../../imports/OnboardingLocationAccess/svg-zskdu63fvz';

export function OnboardingLocationAccessScreen() {
  const navigate = useNavigate();

  const handleAllow = () => {
    navigate('/onboarding/allow-location-access');
  };
