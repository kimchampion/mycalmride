import svgPaths from "./svg-bmz1cupbu4";
  ...
  return (
    <div className="content-stretch flex flex-col gap-[40px] h-[119px] items-center leading-[0] not-italic relative shrink-0 text-[17px] text-center w-full" data-name="Message Text">
      <div className="flex flex-col font-['SF_Pro_Display:Bold',sans-serif] h-[22px] justify-center min-w-full relative shrink-0 text-white w-[min-content]">
        <p className="leading-[22px]">Personalize your experience</p>
      </div>
      <div className="font-['72:Regular',sans-serif] h-[108.362px] relative shrink-0 text-[#e6edf3] w-[278.609px]">
        <p className="leading-[22px] mb-0">Login and set up your profile so we can tailor your support to your comfort level.</p>
    ...
    <div className="bg-[#9ab89c] h-[48px] relative rounded-[16px] shrink-0 w-full" data-name="Button Container">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[8px] relative size-full">
          <p className="font-['SF_Compact_Text:Semibold',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#042b48] text-[17px] text-center whitespace-nowrap">Let’s Get Started</p>
        </div>
      </div>
    </div>
  );
...
export default function OnboardingAccountSetup() {
  return (
    <div className="bg-[#042b48] relative size-full" data-name="onboarding-account setup">
