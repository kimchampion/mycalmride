import svgPaths from "./svg-zr9ur6lgtm";
...
function MessageText() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] h-[119px] items-center not-italic relative shrink-0 text-[17px] text-center w-full" data-name="Message Text">
      <div className="flex flex-col font-['SF_Pro_Display:Bold',sans-serif] h-[22px] justify-center leading-[0] min-w-full relative shrink-0 text-white w-[min-content]">
        <p className="leading-[22px]">Request a Softer Ride</p>
      </div>
      <p className="font-['72:Regular',sans-serif] h-[108.362px] leading-[22px] relative shrink-0 text-[#e6edf3] w-[278.609px]">Let your driver know when you need a softer ride, without having to say it out loud.</p>
    </div>
  );
}
...
export default function OnboardingAppInfo() {
  return (
    <div className="bg-[#042b48] relative size-full" data-name="onboarding-app info">
